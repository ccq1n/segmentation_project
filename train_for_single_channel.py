...
from data.dataloader import SEED2020DataList, TNSCUI2020DataList
...
def main(args):
    ...
    train_branch = [0,1,2,3,4,5,6,7,8]
    val_branch = [9]

    usDataList = TNSCUI2020DataList(dataset_path=args.dataset_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--snapshot', default='best_metric_model_lr_0.00001.pth', type=str, help='checkpoint file')

    parser.add_argument('--dataset_path', default=r'/home/qinyx/Dataset/TNSCUI2020', type=str, help='dataset path')
